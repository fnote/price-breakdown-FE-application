...
const ErrorMessages = {
    ...
    INVALID_CUSTOMER_ACCOUNT_ERROR: 'Customer account is incorrect',
    INVALID_CUSTOMER_ACCOUNT_TYPE_ERROR: 'Customer is not a TRS customer',
    INVALID_OLD_PRICE_REQUEST_DATE_ERROR: 'Could not price for the provided date',
    INVALID_FUTURE_PRICE_REQUEST_DATE_ERROR: 'Could not price for the provided date',
