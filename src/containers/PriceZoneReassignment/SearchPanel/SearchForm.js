...
const SearchForm = () => {
  ...
  // States
  const [isCustomerChecked, setCustomerChecked] = useState(
    isCustomerCheckedInitState
  );
  const [customerTextboxValue, setCustomerTextBoxValue] = useState(
    customerTextboxValueInitState
  );
  const [customerGroupTextboxValue, setCustomerGroupTextBoxValue] = useState(
    customerGroupTextboxValueInitState
  );
  ...
  const getAttributeGroupsFromSeed = () =>
