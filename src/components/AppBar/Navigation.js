  ...
  return (
    <ul className="navigation">
      <Link to={NAVIGATION_PATH_PRICE_VALIDATION}>
          {grantViewPermissionsToScreens(userRole, SCREEN_PRICE_VALIDATION) && (<li className={getClassName(match, NAVIGATION_PATH_PRICE_VALIDATION)}>
      ...
      <Link to={NAVIGATION_PATH_HISTORY_INQUIRY}>
          {grantViewPermissionsToScreens(userRole, SCREEN_HISTORY_INQUIRY) && (<li className={getClassName(match, NAVIGATION_PATH_HISTORY_INQUIRY)}>
        ...
        <Link to={NAVIGATION_PATH_FILE_UPLOAD}>
            {grantViewPermissionsToScreens(userRole, SCREEN_FILE_UPLOAD) && (<li className={getClassName(match, NAVIGATION_PATH_FILE_UPLOAD)}>
       ...
       <Link to={NAVIGATION_PATH_PRICEZONE_REASSIGNMENT}>
           {grantViewPermissionsToScreens(cipzUserRole, SCREEN_CIPZ_REASSIGNMENT) && (<li className={getClassName(match, NAVIGATION_PATH_PRICEZONE_REASSIGNMENT)}>
